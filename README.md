...
Important Note: While the Python script can be executed independently to test camera-based features, the core safety monitoring (sensor readings, real-time safety status, and physical alarm reset) requires the Arduino to be connected and running the provided source code.

📦 Getting Started
1. Hardware Setup
Connect your sensors and components to the Arduino Uno according to your circuit diagram.
...
Ensure you have three audio files (yangin.mp3, gaz.mp3, sicaklik.mp3) in your directory, or update the file paths in the script to point to your audio files.
